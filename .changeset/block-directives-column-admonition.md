---
'@kappan/plugin-admonition': minor
'@kappan/plugin-column': minor
'@kappan/core': minor
'@kappan/plugin-toc': minor
'@kappan/plugin-review-compat': minor
'@kappan/cli': patch
---

ブロックレベルの意味づけ記法を `remark-directive`（`:::`）で導入した。
